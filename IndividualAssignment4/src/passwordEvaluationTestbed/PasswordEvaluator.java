...
public class PasswordEvaluator {
	...
	private static int charCounter;						// The length of the password
	...
	public static String evaluatePassword(String input) {
		...
		charCounter = 0;					// The length of the password
		...
		charCounter++;						// Increment the character counter to include the first character
		...
		while (running) {
			...
			// Go to the next character if there is one and increment the counter to keep track of the length of the password
			currentCharNdx++;
			charCounter++;
			if (currentCharNdx >= inputLine.length() || foundOtherChar)
				running = false;
			else
		...
		if (!foundLongEnough && !foundOtherChar) {
